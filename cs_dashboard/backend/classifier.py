...
FALLBACK_SUBS = {"내부 이력", "부재 처리", "지면학습", "기기 장기미회수", "교사 상담 요청", "유종처리", "기기 교체 요청"}

RULES = [
    ("해지 확정",          ["해지확정", "[해지확정]", ">해지확정", "해지로 처리요청", "해지처리 요청", "구독취소", "구독 취소"]),
    ("해지 방어",          [">성공", "-성공("]),
    ("해지 상담",          ["차 상담]", "해지방어", "방어 상담", "해지 방어 상담", "해지금"]),
    ("해지금·위약금 문의", ["위약금 문의", "위약금 얼마", "위약금이 얼마", "해지금 문의", "해지금 확인", "해지시 위약금", "해지금 상쇄"]),
    ...
    ("앱 오류",            ["공장초기화", "캐시 삭제", "캐시삭제", "앱 오류", "앱오류", "무한 로딩", "무한로딩", "프로그램 오류", "앱 튕김", "앱튕김", "영상 자동 재생"]),
    ("화상수업 오류",      ["화상수업 오류", "화상수업 끊김", "화상코칭 연결", "영상통화 안됨", "수업 중 재부팅"]),
    ("미납 관리",          ["장기미납", "미납 해소", "미납 아웃콜", "정지 해제", "학습정지", "착신정지"]),
    ("카드 변경",          ["카드 변경", "카드변경", "결제카드 변경", "ARS 변경", "카드 등록"]),
    ("환불·결제취소",      ["환불", "청약철회", "결제 취소 요청", "결제취소 요청", "학습비 반환"]),
    ("체험 취소·미인지",   ["체험 취소", "체험취소", "수취거부", "오는줄 몰랐", "단말기 오는줄", "가족 반대", "신청건 취소", "업로드취소"]),
    ...
    ("내부 이력",          ["캐츠에서 상담진행", "캐츠 이력 저장", "캐츠상담", "캐츠홈 상담", "캐츠 상담 진행", "이력 저장", "이력저장", "캐잉 이력", "캐잉이력", "에서 상담진행"]),
    ("부재 처리",          ["부재/sms", "부재/문자", ">부재", "부재 종결", "부재종결", "부재로 문자", "부재로인해"]),
    ("지면학습",           ["지면학습", "지면 학습"]),
    ("기기 장기미회수",    ["장기미회수", "장기 미회수", "재회수 접수"]),
